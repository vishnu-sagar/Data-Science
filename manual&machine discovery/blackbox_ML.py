...
calssifier=tree.DecisionTreeRegressor()
...
graph.write_pdf(r"C:\Users\vichu\Documents\ML\tree.pdf")
...
titanic_test.to_csv(r"C:\Users\vichu\Documents\ML\submission.csv", columns=["PassengerId", "Survived"], index=False)